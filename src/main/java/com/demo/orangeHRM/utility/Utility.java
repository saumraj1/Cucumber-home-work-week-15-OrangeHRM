package com.demo.orangeHRM.utility;

import com.demo.orangeHRM.drivermanager.ManageDriver;
...
public class Utility extends ManageDriver {
    ...
    public void randomEmail(WebElement webElement){
        ...
        webElement.sendKeys("roma"+ randomInt +"@gmail.com");
    }
    public void randomUserName(WebElement webElement){
        Random randomGenerator = new Random();
        int randomInt = randomGenerator.nextInt(1000);
        webElement.sendKeys("roma patel"+ randomInt );
    }
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/demo/orangeHRM/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "/src/main/java/com/demo/orangeHRM/screenshots/" + screenshotName + dateName + ".png";
